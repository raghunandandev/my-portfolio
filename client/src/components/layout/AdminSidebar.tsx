...
//                 className="md:hidden fixed top-4 left-4 z-50 p-2 bg-dark-200 border border-white/10 rounded-md text-white shadow-lg hover:bg-neon-purple transition-colors"
//             >
...
//             {/* ✅ SIDEBAR CONTAINER */}
//             <aside className={`
//                 fixed top-0 left-0 z-40 h-screen w-64 bg-dark-200 border-r border-white/10 
//                 transition-transform duration-300 ease-in-out
//                 ${isOpen ? 'translate-x-0' : '-translate-x-full'} 
//                 md:translate-x-0 md:static md:flex md:flex-col
//             `}>
//                 <div className="p-6 border-b border-white/10 flex items-center justify-center md:justify-start gap-3 mt-12 md:mt-0">
